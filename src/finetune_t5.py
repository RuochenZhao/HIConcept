...
ids_0 = tokenizer.encode('World </s>')
ids_1 = tokenizer.encode('Sports </s>')
ids_2 = tokenizer.encode('Business </s>')
ids_3 = tokenizer.encode('Science </s>')
print('ids_0 World: ', ids_0)
print('ids_1 Sports: ', ids_1)
print('ids_2 Business: ', ids_2)
print('ids_3 Science: ', ids_3)
...
class T5FineTuner(pl.LightningModule):
  ...
  def train_dataloader(self):
    ...
    train_dataset = get_dataset(self.tokenizer, x_train, y_train, args=self.hparams)
  ...
  def val_dataloader(self):
    ...
    val_dataset = get_dataset(self.tokenizer, x_val, y_val, args=self.hparams)
...
dataset = NewsDataset(tokenizer, x_train, y_train,  max_len=512)

args_dict.update({'output_dir': 'models/news/t5', 'num_train_epochs':2})
args = argparse.Namespace(**args_dict)

checkpoint_callback = pl.callbacks.ModelCheckpoint(
    dirpath=args.output_dir, filename="{epoch}-checkpoint", monitor="val_loss", mode="min"
)
...
model.model.save_pretrained('models/news/t5/pretrained_t5_model')